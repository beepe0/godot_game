...
public partial class Game : Node
{
 ...
 //    }
	public override void _Process(double delta)
	{
		...
		DrawGizmos.Text($"RenderTotalDrawCallsInFrame: {Performance.GetMonitor(Performance.Monitor.RenderTotalDrawCallsInFrame)}");
		DrawGizmos.Text($"RenderTotalPrimitivesInFrame: {Performance.GetMonitor(Performance.Monitor.RenderTotalPrimitivesInFrame)}");
		DrawGizmos.Text($"ObjectCount: {Performance.GetMonitor(Performance.Monitor.ObjectCount)}");
		DrawGizmos.Text($"ObjectResourceCount: {Performance.GetMonitor(Performance.Monitor.ObjectResourceCount)}");
		DrawGizmos.Text($"ObjectNodeCount: {Performance.GetMonitor(Performance.Monitor.ObjectNodeCount)}");
		DrawGizmos.Text($"ObjectOrphanNodeCount: {Performance.GetMonitor(Performance.Monitor.ObjectOrphanNodeCount)}");
		DrawGizmos.Text("=================================================", 0, Colors.Red);
    }
}
